const Images = {
  ...
  default_Item_5: require("../images/default_Category/default_Item_5.jpg"),
  default_Item_6: require("../images/default_Category/default_Item_6.jpg"),
  ...
  splashScreen: require("../images/placeholderImage.png"),
