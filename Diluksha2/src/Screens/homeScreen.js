    ...
    return (
      <View style={styles.container}>
        {(this.state.isLoading)?<View
            style={{flex: 1, marginTop:width*0.8}}>
          ...
          <ScrollView>
            ...
            {/* <View style={{alignItems:"center",marginTop:25}}>
              ...
              <SliderBox
                ...
                resizeMode='contain'
                ImageComponentStyle={{ width: width * 0.95, height: width * 0.45, resizeMode:'contain', borderRadius:7, alignSelf:'center' }}
              />
              ...
              <TouchableOpacity
                ...
                onPress={() => this.props.navigation.navigate('EmailList')}>
                  <Image 
                    ...
                    style={{width:width * 0.95,height:width * 0.4, resizeMode:'contain', borderRadius:7}}
                  />
              </TouchableOpacity>
            </View>
