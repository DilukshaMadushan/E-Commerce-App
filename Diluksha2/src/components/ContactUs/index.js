...
import {Text, View, Dimensions, StyleSheet, ScrollView, ActivityIndicator, Image, TextInput, TouchableOpacity} from 'react-native';
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={{alignSelf: 'center', marginTop:10}}>
            <Image source={require('../../images/logo-main.png')} style={{width:width*0.6, height:100, resizeMode:'contain'}}></Image>
        </View>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          ...
          No. C16, 3rd floor, Commercial Center,
                      Bandarawela.
          </Text>
        </View>
        ...
        <View style={Formstyles.container}>
          ...
          <View>
            ...
            <TouchableOpacity
              activeOpacity={0.6}
              delayPressIn={0} 
              style={Formstyles.Button} onPress={this.sendMessage}>
