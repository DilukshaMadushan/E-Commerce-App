    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <View>
            <Text style={{fontSize:15, marginLeft:15}}>Full name|සම්පූර්ණ නම|முழு பெயர்</Text>
            <TextInput
          ...
          <View>
            <Text style={{fontSize:15, marginLeft:15}}>Phone No |දුරකතන අංකය|ப ொலைபெசி எண்</Text>
            <TextInput
              style={styles.TextView}
          ...
          <View>
            <Text style={{fontSize:15, marginLeft:15}}>Address |ලිපිනය |முகவரி</Text>
            <TextInput
              style={styles.TextView}
          ...
          <TouchableOpacity
            activeOpacity={0.6}
            delayPressIn={0}
            style={[styles.Button, {backgroundColor: '#ed1b24'}]}
            onPress={this._pickImage}>
              <View style={{flexDirection:'row'}}>
                <Image
                  style={{height:27,width:27}}
                  resizeMode="contain"
                  source={require('../../images/my-icons/upload.png')}
                />
          ...
          <TouchableOpacity
            ...
            <View style={{flexDirection:'row'}}>
                ...
                <Image
                  ...
                  resizeMode="contain"
                  source={require('../../images/my-icons/plane.png')}
                />
