...
class CategoryItems extends Component {
  ...
  show = (value) => {
    ...
    if (value == '1') {
      ...
      this.getItems(this.state.categoryId, this.state.page, 'title&order=asc');
    } else if (value == '2') {
      this.setState({pickerSelectedValue:'price&order=asc'});
      this.getItems(this.state.categoryId, this.state.page, 'price&order=asc');
    } else if (value == '3') {
      this.setState({pickerSelectedValue:'rating&order=asc'});
      this.getItems(this.state.categoryId, this.state.page, 'rating&order=asc');
    }
  };
                ...
                <View>
                  <Modal isVisible={this.state.isSubCatModelVisible}>
                    <View style={{
                      ...
                      <ScrollView>
                        <Text style={{fontSize:20}}>Select a Sub Category</Text>
                        ...
                        <FlatList
                          ...
                          renderItem={({item}) => (
                            <TouchableOpacity
                              ...
                              >
                              <Text style={{fontSize:17, color:'gray'}}>{item.name}</Text>
