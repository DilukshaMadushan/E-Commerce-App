  ...
  return (
    <View style={styles.item} activeOpacity={0.7}>
      ...
      <View
        ...
        {regularPrice === ItemPrice || regularPrice === '' ? (
          <View></View>
        ) : (
          <Text style={styles.ItemDiscount}>
            {Math.round(
              ((parseFloat(regularPrice) - parseFloat(ItemPrice)) /
                ...
                <View
                  ...
                  <View style={{flex: 1, width: width / 2}}>
                    <Picker
                      ...
                      <Picker.Item label="A-Z" color="#162539" value="1" />
                      <Picker.Item label="Price" color="#162539" value="2" />
                      <Picker.Item label="Rating" color="#162539" value="3" />
                    </Picker>
                  </View>
                </View>
