        ...
        {this.state.isLoading == false ? (
          <View>
            ...
            <ScrollView style={{flexDirection: 'column', marginBottom: 135}}>
              ...
              <View style={styles.Itemrows}>
                <Text style={styles.TextInputsName}>Address</Text>
                <TextInput
                  style={styles.TextInputs}
              ...
              <View style={styles.Itemrows}>
                ...
                <View style={{flex: 2, marginRight: 10}}>
                  <DropDownPicker
                    ...
                    placeholder={
                      !this.checkTheCity() ? 'Select a City' : this.state.city
                    }
              ...
              <View style={styles.Itemrows}>
                <Text style={styles.TextInputsName}>Phone No</Text>
                <TextInput
